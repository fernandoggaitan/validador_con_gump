        ...
        foreach ($this->errors as $e) {
            ...
            switch ($e['rule']) {
                ...
                case 'validate_required' :
                    ...
                    $resp[] = "<span class=\"$field_class\">$field</span> es un campo obligatorio";
                    break;
                case 'validate_valid_email':
                    //$resp[] = "The <span class=\"$field_class\">$field</span> field is required to be a valid email address";
                    $resp[] = "<span class=\"$field_class\">$field</span> debe ser un correo electrónico válido";   
                    break;
                case 'validate_max_len':
                    //$resp[] = "The <span class=\"$field_class\">$field</span> field needs to be $param or shorter in length";
                    $resp[] = "<span class=\"$field_class\">$field</span> debe tener un máximo de $param caracteres de largo";
                    break;
                case 'validate_min_len':
                    //$resp[] = "The <span class=\"$field_class\">$field</span> field needs to be $param or longer in length";
                    $resp[] = "<span class=\"$field_class\">$field</span> debe tener un mínimo de $param caracteres de largo";
                    break;
